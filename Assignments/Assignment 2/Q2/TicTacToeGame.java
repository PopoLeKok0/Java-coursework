...
public class TicTacToeGame {
    ...
    *  the TicTacToeGame instance to be compared with this one
	...
	public boolean equals(TicTacToeGame other) {
		...
		boolean check = false;
		if((lines == other.lines) && (columns == other.columns) && (sizeWin == other.sizeWin) && (getGameState() == other.getGameState())	&& (getLevel() == other.getLevel())){
			check = true;
			for(int i = 0; i < columns*lines && check; i++){
